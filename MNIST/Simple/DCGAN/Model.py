...
class DCGAN() :
    ...
    def get_discriminator_loss(self, real_logits, fake_logits) :
        real_loss = self.loss_function(tf.ones_like(real_logits) * self.smoothing, real_logits)
        fake_loss = self.loss_function(tf.zeros_like(fake_logits), fake_logits)
        return real_loss + fake_loss

    def get_generator_loss(self, fake_logits) :
        return self.loss_function(tf.ones_like(fake_logits) * self.smoothing, fake_logits)        
