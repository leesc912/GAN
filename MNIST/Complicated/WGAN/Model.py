...
class WGAN_GP() :
    ...
    def __init__(self, **kwargs) :
        ...
        self.n_critic = kwargs["n_critic"]
        self.latent_size = kwargs["latent_size"]
        self.gp_coefficient = kwargs["gp_coefficient"]
        self.lr = kwargs["lr"]
    ...
    def train(self, **kwargs) :
        ...
        self.critic = self.make_critic(**kwargs)
        ...
        self.g_opt = tf.keras.optimizers.Adam(lr = self.g_lr, beta_1 = kwargs["beta1"], beta_2 = kwargs["beta2"])
        self.c_opt = tf.keras.optimizers.Adam(lr = self.c_lr, beta_1 = kwargs["beta1"], beta_2 = kwargs["beta2"])
